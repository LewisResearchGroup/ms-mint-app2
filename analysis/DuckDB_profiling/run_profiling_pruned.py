"""
Variant profiler with a pruned ms1 query to reduce scans of ms1_data.
Baseline run_profiling.py is left untouched; use this to compare performance.
"""
...
# MS1 with file-level pruning to avoid scanning all ms1_data per batch
MS1_QUERY = """
...
# Keep ms2/results queries identical to baseline for comparison
MS2_QUERY = """
INSERT INTO chromatograms (peak_label, ms_file_label, scan_time, intensity, ms_type)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Profile heavy DuckDB queries (EXPLAIN ANALYZE) with pruned ms1 query.")
...
def main():
    ...
    out_name = args.output or f"{args.query}_{args.start_id}-{args.end_id}_pruned.json"
